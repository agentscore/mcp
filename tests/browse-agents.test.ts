...
describe('browse_agents', () => {
  ...
  describe('API endpoint and params', () => {
    ...
    it('passes cursor param when provided', async () => {
      ...
      await handler({ cursor: 'cursor_xyz_456' });

      expect(mockApiGet).toHaveBeenCalledWith('/v1/agents', { limit: '10', cursor: 'cursor_xyz_456' });
    });
  ...
  describe('error handling', () => {
    ...
    it('returns auth error for 401 unauthorized', async () => {
