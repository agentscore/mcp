...
[![npm version](https://img.shields.io/npm/v/@agentscore/mcp.svg)](https://www.npmjs.com/package/@agentscore/mcp)
...
```bash
claude mcp add agentscore -e AGENTSCORE_API_KEY=ask_... -- npx -y @agentscore/mcp
```
